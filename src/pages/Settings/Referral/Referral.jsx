...
import { DialogTitle, TableCell, TableRow, Table, TableBody, TextField } from '@material-ui/core';
  ...
  return (
    <Fragment>
      ...
      <div className={classes.text}>
        Onexbit has upgraded our Referral Program! Invite your friends to register and trade inside
        our terminal, just share the code below and you will get part of your referral's income
        after they buing subscriptions to our services.
      </div>

      <TextField value={user.referralCode} className={classes.refCode} />

      <div className={classes.text}>
        For each registered referral you will have these percentage of his deposits:
      </div>
      ...
      {referrals.referrals[1] ? (
        ...
        <div className={classes.text}>Currently you don't have anyone invited.</div>
      )}
    </Fragment>
  );
};
